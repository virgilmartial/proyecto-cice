    ...
    <div class="">
        <form class="" action="form_matricula_paso2.php">
            ...
            <div class="form-row  py-3">
                <legend class="col-form-label col-md-4">Sexo<span class="etoile c4">*</span></legend>
                <div class="flex">
            ...
            <div class="flex flex--between">
                <div class="w30">
                    <label for="fechaNaci">Fecha de nacimiento<span class="etoile c4">*</span></label>
                    <input type="date" class="form-control" id="fechaNaci" name="fechaNaci">
                </div>
                <div class="w30">
                    <label for="fechaNaci">Lugar de nacimiento<span class="etoile c4">*</span></label>
                    <select id="lugarnaci" name="lugarnaci"  class="form-control custom-select custom-select-md">
                ...
                <div class="w30">
                    <label for="localidad">Localidad<span class="etoile c4">*</span></label>
                    <input type="text" class="form-control" id="localidad" name="localidad">
                </div>
            </div>
            <div class="flex flex--between">
                <div class="w45">
                    <label for="paisResidenci">Pais de residencia<span class="etoile c4">*</span></label>
                    <select class="form-control custom-select custom-select-md" id="paisresi" name="paisresi">
                        <option value="CA">Canada</option>
                        <option value="AF">Afghanistan</option>
                        <option value="ZA">Afrique du sud</option>
                        <option value="AX">Åland, îles</option>
                ...
                <div class="w45">
                    <label for="direccion">direccion<span class="etoile c4">*</span></label>
                    <input type="text" class="form-control" id="direccion" name="direccion">
                </div>
            </div>
            <div class="flex flex--between">
                <div class="w30">
                    <label for="Telefono">Telefono<span class="etoile c4">*</span></label>
                    <input type="tel" class="form-control" id="telefono" name="telefono">
                </div>

                <div class="w30">
                    <label for="email">Email<span class="etoile c4">*</span></label>
                    <input type="email" class="form-control" id="email" name="email">
                </div>
                <div class="w30">
                    <label for="email">Confirma el Email<span class="etoile c4">*</span></label>
                    <input type="email" class="form-control" id="email">
                </div>
            </div>

            <div class="flex flex--between">
                <button class="c4"><a href="index.php">Cancelar</a></button>
                <div class=""><input class="bgc2 continuar" type="submit" value="continuar"></div>
            </div>
